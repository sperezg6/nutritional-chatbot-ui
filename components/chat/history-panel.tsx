      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed left-0 top-0 bottom-0 w-80 max-w-[90vw] bg-[#FAFAF7] shadow-2xl z-50 flex flex-col border-r border-gray-200"
          >
            {/* Header */}
            <div className="border-b border-gray-200 px-6 py-6 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">Historial de chats</h2>
              <button
                onClick={onClose}
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-alba-primary hover:bg-alba-primary-dark text-black font-medium transition-all duration-200 shadow-sm hover:shadow-md"
              >
              ...
              <div className="px-6 py-3 border-b border-gray-200">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-sm bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-alba-primary/50 focus:border-alba-primary/50 text-gray-900 placeholder-gray-500 transition-all"
                  />
                </div>
              </div>
            )}
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      currentConversationId === conversation.id
                        ? "bg-alba-primary/10 border-l-4 border-l-alba-primary"
                        : "hover:bg-gray-100"
                    )}
                      ...
                      <div className="flex-1 min-w-0 pr-16">
                        {editingId === conversation.id ? (
                          <input
                            ...
                            className="w-full px-2 py-1 text-sm border border-alba-primary/50 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-alba-primary/50"
                            autoFocus
                          />
                        ) : (
                          <div className="font-medium text-gray-900 text-sm leading-tight flex items-center gap-2">
                            {conversation.title}
                            {savingId === conversation.id && (
                              <Loader2 className="w-3 h-3 animate-spin text-alba-primary" />
                            )}
                          </div>
                        )}
            ...
            {/* Footer */}
            <div className="px-6 py-4 border-t border-gray-200 text-xs text-gray-500 text-center flex items-center justify-center gap-2">
              <div className="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 font-medium text-xs">
                N
              </div>
